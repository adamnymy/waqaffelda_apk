...
/// Islamic & Gregorian Combined Calendar Page
/// Shows dual calendar view with Islamic holidays and custom events
/// Features: Hijri/Gregorian toggle, event management, holiday information
...
class _CombinedCalendarPageState extends State<CombinedCalendarPage> {
  ...
  final List<Map<String, dynamic>> _importantIslamicEvents = [
    ...
    },
    {
      ...
      'name_ms': 'Nuzul Quran',
      'details_ms':
          'Wahyu pertama diturunkan kepada Nabi Muhammad SAW di Gua Hira\' pada 17 Ramadan. Permulaan turunnya Al-Quran sebagai petunjuk untuk umat manusia.',
      'month': 9, // Ramadan
      'day': 17,
      'range': false,
      'isHijri': true,
    ...
    // Historical Islamic Events
    {
      ...
      'details_ms':
          'Perpindahan Nabi SAW dan para sahabat dari Mekah ke Madinah pada 1 Rabiulawal, menandakan titik permulaan perkembangan Islam dan kalendar Hijriah.',
      'month': 3, // Rabi'ulawal
      'day': 1,
      'range': false,
      'isHijri': true,
    ...
    },
    {
      ...
      'details_ms':
          'Detik kesedihan teragung umat Islam. Nabi Muhammad SAW wafat pada 12 Rabiulawal 11H, meninggalkan warisan agung untuk umat manusia.',
      'month': 3, // Rabi'ulawal
      'day': 12,
      'range': false,
      'isHijri': true,
    ...
    return Scaffold(
                                    ...
                                    if (dt.month == ev['month']) {
                                      if (ev['isFirstSaturday'] == true) {
                                        ...
                                        if (dt.month == 6 && dt.weekday == 6) {
                                          ...
                                          final firstSaturday = firstDayOfMonth
                                              .add(
                                                Duration(
                                                  days: daysToFirstSaturday,
                                                ),
                                              );
                                          if (dt.day == firstSaturday.day) {
                                            matchedHolidays.add(ev);
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
          ...
          child: Icon(Icons.add, color: Colors.white, size: isMobile ? 20 : 24),
        ),
      ),
    );
  }
                        ...
                        if (holidayObjects.isNotEmpty && _showBuiltInHolidays)
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: (holidayObjects.first['color']
                                          as Color)
                                      .withOpacity(0.3),
                                  blurRadius: 8,
                                  offset: const Offset(0, 4),
