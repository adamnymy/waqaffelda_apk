  ...
  final List<Map<String, dynamic>> notifications = [
    {
      'id': '1',
      'title':
          'Ziarah Kasih: Agihan Manfaat WAQAF FELDA bersama Warga FELDA Lok Heng Barat',
      'description':
          'Tidak akan berkurang harta dengan sedekah, bahkan bertambah dengan keberkatan, Ayuh teruskan kebaikan ini bersama Waqaf FELDA.',
      'date': '4 Minggu lalu',
      ...
      'facebookUrl':
          'https://www.facebook.com/share/v/1F2hVFmcEi/', // Ganti dengan URL post anda
    },
    {
      'id': '2',
      'title':
          'Agihan Manfaat Gelandangan di Sekitar Kuala Lumpur dengan kerjasama YAYASAN FELDA dan PERSADA',
      'description':
          'Pada Bulan Ramadan yang mulia ini, Waqaf FELDA dengan kerjasama YAYASAN FELDA dan PERSADA telah mengagihkan manfaat kepada golongan gelandangan di sekitar Kuala Lumpur.',
      'date': '9 Bulan lalu',
    ...
    },
    {
      ...
      'description':
          'Mari tinggalkan bekalan penuh makna dengan berwakaf melalui Set Persalinan Akhir & Waqaf Al-Quran bersama Waqaf FELDA — hadiah abadi yang terus mengalir pahalanya.',
      'date': '2 Bulan lalu',
    ...
    },
    {
      ...
      'description':
          'WAQAF FELDA menyeru semua petugas kumpulan FELDA untuk bersama menyertai amalan wakaf secara konsisten melalui potongan gaji bulanan.',
      'date': '2 Bulan lalu',
    ...
    },
    {
      ...
      'description':
          'Allah pasti bukakan jalan untuk lebih banyak kebaikan, Inshaa Allah.',
      'date': '1 Bulan lalu',
      'image': 'assets/images/SPAT1.png',
      'isRead': true,
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Tidak dapat membuka pautan Facebook. Sila cuba lagi.',
            ),
                      ...
                      border: Border.all(
                        color:
                            isRead
                                ...
                                : (notification['color'] as Color).withOpacity(
                                  0.3,
                                ),
                        width: 1,
                      ),
